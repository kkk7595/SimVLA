...
def create_libero_meta(
    ...
    """
    Create FRANKA dataset meta configuration.
    
    Args:
        data_dir: FRANKA dataset root directory
    ...
    print(f"Scanning FRANKA dataset: {data_dir}")
    ...
    meta = {
        ...
        "subset_stats": stats,
        "observation_key": ["right/obs/agentview_rgb", 
                            "right/obs/eye_in_hand_rgb", 
                            "right/obs/arm_joint", 
                            "right/obs/hand_joint", 
                            "right/obs/ee_ori",
                            "right/obs/ee_pos"],
        "action_key": ["right/arm_actions", "right/hand_actions"],
        "state_dim": 12,
        "action_dim": 12,
        "fps": 30,
    }
...
def main():
    parser = argparse.ArgumentParser(description="Create FRANKA training metadata")
    ...
    parser.add_argument("--output", type=str,
                        default="./datasets/metas/franka_train.json",
    ...
    args.output= "/home/keep/Desktop/project/X-RLinf/dataset/franka-l6-20260503/franka_train.json"
